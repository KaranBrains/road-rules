...
export const baseUrl = "https://backend.gadschool.com:8082/";
export const paymentUrlBooking = "https://backend.gadschool.com:8082/api/create-checkout-session-booking";
export const paymentUrl = "https://backend.gadschool.com:8082/api/create-checkout-session";
// rebuild
