...
export const url = "https://backend.gadschool.com:1234/api";
export const baseUrl = "https://backend.gadschool.com:1234/";
export const paymentUrlBooking = "https://backend.gadschool.com:1234/api/create-checkout-session-booking";
export const paymentUrl = "https://backend.gadschool.com:1234/api/create-checkout-session";
// rebuild
