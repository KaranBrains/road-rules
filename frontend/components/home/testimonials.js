  ...
  return (
    <div className="my-5 auth-bg">
      <div className={`container ${styles.pySection} px-4`}>
        ...
        {/* <Carousel controls={false} fade indicators>
          <Carousel.Item interval={1000}>
          <div
            className={`col-12 p-4 d-flex justify-content-center ${styles.mobileCenter}`}
          >
            <div className=" col-lg-4 col-md-4 col-sm-6 col-12 rounded border">
              <div className="">
                <h4 className="text-primaryColor mt-4 mb-3 font-18 font-bold text-center">
                Joban Sandhu
                </h4>
