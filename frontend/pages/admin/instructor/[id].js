...
export default function InstructorId() {
  ...
  useEffect(() => {
    if (id !== undefined) {
      dispatch(GetInstructorById(id)).then(() => {
        setShowText(true);
      });
    }
  }, [id]);
  ...
  const initialState = {
    fullName: instructorById?.fullName,
    img: instructorById?.img,
    phone: instructorById?.phone,
          ...
          <Modal.Body>
            <form>
              ...
              <div className="form-group">
                ...
                <div
                  className="btn font-20 font-bold bg-tertiaryColor w-100 mt-2"
                  onClick={() => document.getElementById("uploading")?.click()}
                >
                  Upload
                </div>
                <input
            ...
            <div className="col-lg-3 col-md-4 col-sm-12 col-12 ">
              <div className="py-3 bg-tertiaryColor">
                <div class="text-center">
                  <img
                    src={baseUrl + instructorById?.img}
                    alt="img"
                    class="mb-3 img-fluid user-img"
                  />
                </div>
              </div>
            </div>
            <div className="col-lg-9 col-md-8 col-sm-12 col-12">
              <div className="bg-tertiaryColor h-100 py-5 px-2">
                ...
                <div className="d-flex flex-column flex-lg-row flex-sm-column flex-md-column">
                  <input
                    className="form-control font-20"
                    value={instructorById?.email}
                    disabled
                  ></input>
                  <input
                    className="ml-2 form-control font-20"
                    value={instructorById?.phone}
                    disabled
                  ></input>
                </div>
              </div>
