...
import { getTestimonial ,updateTestimonial } from "../../../redux/actions/testimonial";
...
export default function AllRides() {
  ...
  const handleSubmitUpdate = (id,e) => {
    e.preventDefault();
    dispatch(updateTestimonial(editFormData,router))
    .then(()=>{
      handleEditClose();
    });
  };
                        ...
                        testimonialOptions.map(val => {
                          i++;
                            return (
                              ...
                              <td>
                                <a>
                                <div class="btn btn-primary user-button" onClick={()=>EditSlot(val._id,val.name,val.comment)}>Edit</div>
                                </a>
                              </td>
                          </tr>
                            )
