        ...
        <div className="row">
          <div className="col-lg-12 col-md-12 col-sm-12 col-12">
            <div className="bg-customColor h-100 py-5">
              <div>
                <input
                  className="form-control bg-customColor font-20"
              ...
              <div className="d-flex flex-column flex-lg-row flex-sm-column flex-md-column">
                ...
                ></input>
                <input
                  className="ml-2 form-control bg-customColor font-20"
              ...
              <div>
                {user?.user?.address && user?.user?.address.length > 0 ? (
                  <input
                    className="form-control font-weight-bold bg-customColor font-20"
                    value="Address"
                    disabled
                  ></input>
                ) : (
                          ...
                          <Link href={"/admin/all-rides/" + val._id}>
                            <a>
                              <div
                                ...
                                onClick={() =>
                                  router.push("/admin/all-rides/" + [val._id])
                                }
                              >
                                View Details
                              </div>
