      ...
      <div>
        ...
        <div className="row">
          ...
          <div className="bg-tertiaryColor h-100 py-5 px-2">
            <div>
            <input className="form-control font-20" value={user?.user?.fullName} disabled></input>
            </div>
            <div className="d-flex flex-column flex-lg-row flex-sm-column flex-md-column">
              <input className="form-control font-20" value={user?.user?.email} disabled></input>
              <input className="ml-2 form-control font-20" value={user?.user?.phone} disabled></input>
            </div>
          </div>
          </div>
         </div>
